...
menu = pygame_menu.Menu(SQUARE_SIDE*8, SQUARE_SIDE*8, 'Set Difficulty', theme=pygame_menu.themes.THEME_GREEN)
menu.add_selector('Difficulty : ', [('Easy', 0), ('Medium', 1), ('Hard', 2)],
...
def make_AI_move(game, color, level):
